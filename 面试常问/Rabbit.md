...
- 流量削锋 - 可以通过消息队列长度控制请求量；可以缓解短时间内的高并发请 求。 保护服务器和数据库。
- 日志处理 - 解决大量日志传输。 
...
![消息的顺序问题](C:/Users/kgliu/Desktop/新建文件夹 (2)/700道面试题/03-2020最新整理一线大厂面试题合集(重点看)(1)/15-消息中间件MQ面试题（2020最新版）.assets/消息的顺序问题.png)

解决方案： （1）保证生产者 - MQServer - 消费者是一对一对一的关系

![消息的顺序问题2](C:/Users/kgliu/Desktop/新建文件夹 (2)/700道面试题/03-2020最新整理一线大厂面试题合集(重点看)(1)/15-消息中间件MQ面试题（2020最新版）.assets/消息的顺序问题2.png)
...
![simple模式](C:/Users/kgliu/Desktop/新建文件夹 (2)/700道面试题/03-2020最新整理一线大厂面试题合集(重点看)(1)/15-消息中间件MQ面试题（2020最新版）.assets/simple模式.png)
...
![work工作模式](C:/Users/kgliu/Desktop/新建文件夹 (2)/700道面试题/03-2020最新整理一线大厂面试题合集(重点看)(1)/15-消息中间件MQ面试题（2020最新版）.assets/work工作模式.png)
...
![publish_subscribe发布订阅(C:/Users/kgliu/Desktop/新建文件夹 (2)/700道面试题/03-2020最新整理一线大厂面试题合集(重点看)(1)/15-消息中间件MQ面试题（2020最新版）.assets/publish_subscribe发布订阅(共享资源).png)](15-消息中间件MQ面试题（2020最新版）.assets/publish_subscribe发布订阅(共享资源).png)1、每个消费者监听自己的队列； 

2、生产者将消息发给broker，由交换机将消息转发到绑定此交换机的每个队 列，每个绑定交换机的队列都将接收到消息。 

### 四.routing路由模式

![routing路由模式](C:/Users/kgliu/Desktop/新建文件夹 (2)/700道面试题/03-2020最新整理一线大厂面试题合集(重点看)(1)/15-消息中间件MQ面试题（2020最新版）.assets/routing路由模式.png)1.消息生产者将消息发送给交换机按照路由判断,路由是字符串(info) 当前产生的 消息携带路由字符(对象的方法),交换机根据路由的key,只能匹配上路由key对应的消息队列,对应的消费者才能消费消息; 
...
![topic 主题模式(C:/Users/kgliu/Desktop/新建文件夹 (2)/700道面试题/03-2020最新整理一线大厂面试题合集(重点看)(1)/15-消息中间件MQ面试题（2020最新版）.assets/topic 主题模式(路由模式的一种).png)](15-消息中间件MQ面试题（2020最新版）.assets/topic 主题模式(路由模式的一种).png)
1.星号井号代表通配符 
